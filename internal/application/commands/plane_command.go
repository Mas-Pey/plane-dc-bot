...
type PlaneCommand struct {
	...
	PlaneService *services.PlaneService `inject:"planeService"`
}
...
func (c *PlaneCommand) handleUpdate(s *discordgo.Session, i *discordgo.Interaction, options []*discordgo.ApplicationCommandInteractionDataOption) {
	...
	stateUUID := optionMap["state"].StringValue()

	stateNames := map[string]string{
		"48590cb9-a347-4c70-977e-3b1cea8ee10d": "Backlog",
		"c5892faf-2833-4862-a305-afb38c622bb4": "Todo",
		"bc430310-0bc9-4e25-aae4-4d88ad87ede7": "In Progress",
		"37077556-8a4b-48b4-9d08-19a4eb170e23": "QA",
		"05c896af-4d36-4919-8822-f298ae2ef8df": "DoneQA",
		"244c98a5-f67f-4d70-a546-da7b316e7877": "Done",
		"6087999f-b31b-43c0-9186-14ee519a9767": "Cancelled",
	}

	readableStateName, found := stateNames[stateUUID]
	if !found {
		readableStateName = "Unknown State" // Fallback kalau UUID tidak dikenal
	}

	err := c.PlaneService.UpdateStateIssue(issueID, stateUUID)
	if err != nil {
		c.respondError(s, i, fmt.Sprintf("Failed update to Plane: %v", err))
		return
	}

	embed := &discordgo.MessageEmbed{
		Title:       "✅ Issue Updated Succesfully",
		Description: fmt.Sprintf("The issue **%s** has been updated in Plane.", issueID),
		Color:       0x00FF00,
	...
	c.respondEmbedSuccess(s, i, embed)
}
...
func (c *PlaneCommand) respondEmbedSuccess(s *discordgo.Session, i *discordgo.Interaction, embed *discordgo.MessageEmbed) {
	s.InteractionRespond(i, &discordgo.InteractionResponse{
		Type: discordgo.InteractionResponseChannelMessageWithSource,
